...
export function ConceptInstancesPreprocessing({ children, data }) {
    console.log("PUBLIC_URL:", process.env.PUBLIC_URL);
    console.log("ConceptInstances:", data);
    ...
    const preprocessedKnowledgeGraph = kgBuilder.makeConceptInstancesListKG(
        data
    );
